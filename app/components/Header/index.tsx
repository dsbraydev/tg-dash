                    ...
                    >
                        <span className="relative block h-5.5 w-5.5 cursor-pointer">
                            <span className="du-block absolute right-0 h-full w-full">
                                <span
                                    className={`relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-[0] duration-200 ease-in-out dark:bg-white ${!isDropdownOpen ? '!w-full delay-300' : ''
                                        }`}
                                ></span>
                                <span
                                    className={`relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white ${!isDropdownOpen ? '!w-full delay-400' : ''
                                        }`}
                                ></span>
                                <span
                                    className={`relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white ${!isDropdownOpen ? '!w-full delay-500' : ''
                                        }`}
                                ></span>
                            </span>
                            <span className="du-block absolute right-0 h-full w-full rotate-45">
                                <span
                                    className={`absolute left-2.5 top-0 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white ${!isDropdownOpen ? '!h-0 delay-[0]' : ''
                                        }`}
                                ></span>
                                <span
                                    className={`delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white ${!isDropdownOpen ? '!h-0 dealy-200' : ''
                                        }`}
                                ></span>
                            </span>
                        </span>
                ...
                <div className='flex items-center gap-3 2xsm:gap-7'>
                    <ul className="flex items-center gap-2 2xsm:gap-4">
                        ...
                        >
                            ...
                            <div
                                className={`absolute -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 ${isNotificationsOpen ? 'block' : 'hidden'
                                    }`}
                            >
                    ...
                    <div className="relative" onClick={toggleDropdown}>
                        ...
                        >
                            ...
                            <svg
                                className={`hidden fill-current sm:block ${isDropdownOpen && 'rotate-180'}`}
                                width="12"
                                height="8"
                                viewBox="0 0 12 8"
                                fill="none"
